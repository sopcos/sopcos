...
// Mandatory only if the decision is generated by a Synapse AI Agent (SIP-015).
"provenance": {
    "agent_id":        "did:sopcos:node:...", // The DID of the Axon Node
    "model_artifact":  "urn:sopcos:artifact:...", // Reference to the Model Weights in SIP-014 Vault
    "confidence":      0.98,                  // Float value at the moment of decision
    "mandate_ref":     "urn:sopcos:mandate:..." // Reference to the SIP-012 Authority
}
```
