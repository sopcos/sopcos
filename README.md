...
**“Autonomy demands accountability. We are not just shipping fast; we are shipping responsibly.”**
...
👉 **See the full constitution in [`/SIPs`](./SIPs/README.md)**  
👉 **Governance & authority model:** [`/governance/GOVERNANCE.md`](./governance/GOVERNANCE.md)
...
* **Proof of Foreknowledge:**  
  Simulation records eliminate the defense of *“I didn’t know the consequences.”*
...
> These licenses are chosen to protect protocol integrity,
> not to restrict legitimate industrial use.

---

→ Conceptual overview: see [litepaper/LITEPAPER_v2.0.md](./litepaper/LITEPAPER_v2.0.md)
→ Legal & insurance interpretation: see [assurance/SAF_v1.1.md](./assurance/SAF_v1.1.md)
